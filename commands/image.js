...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx2 I Am;BLUEBOT_`)
        var txt = text.split(";")
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx3 I Am;BLUEBOT_`)
        var txt = text.split(";")
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx4 I Am;BLUEBOT_`)
        var txt = text.split(";")
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide three texts*_\n_example: ${prefix}gfx6 I Am;BLUEBOT;Dev_`)
        var txt = text.split(";")
        if (txt.length < 3) return await m.send(`_*provide all three texts separated by semicolons*_\n_example: ${prefix}gfx6 I Am;BLUEBOT;Dev_`)
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx7 I Am;BLUEBOT_`)
        var txt = text.split(";")
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx8 I Am;BLUEBOT_`)
        var txt = text.split(";")
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx10 BLUEBOT_`)
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx11 BLUEBOT_`)
        await m.react("⏳")
...
bluebot({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx12 BLUEBOT_`)
        await m.react("⏳")
...
bluebot({
  ...
  try {
        const response = await m.axios(`https://api.BLUEBOT.live/api/lumina/search?query=${text}`)
